 ...
 */
$host = "manueladb.cqhf3zpl4y7i.us-east-2.rds.amazonaws.com";                                    // MySQL host name eg. localhost
$user = "damin";                                         // MySQL user. eg. root
$password = "manueladb";                                         // MySQL user password 
